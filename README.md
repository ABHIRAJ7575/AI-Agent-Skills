...
Claude and Anthropic
    ...
    Using skills in Claude - Official quick start guide
...
Create a skill:
    ...
    Create a subdirectory for your skill (e.g., .github/skills/webapp-testing)
...
Adding skills to your repository:
    ...
    Create a .github/skills directory (skills in .claude/skills are also supported)
    Create a subdirectory for your skill (e.g., .github/skills/webapp-testing)
...
LangChain Tools
    ...
    Google Search - Wrapper around SerpApi
...
How do I create my first Agent Skill?
    ...
    Create a SKILL.md file with a name and description at the top
    Write clear, step-by-step instructions in the file
    Put it in your .github/skills/ or .claude/skills/ folder
    Test it out!
...
The principles in these skills are derived from research and production experience at leading AI labs and framework developers.
    ...
    Anthropic: Using skills in Claude
    Anthropic: Creating custom skills
